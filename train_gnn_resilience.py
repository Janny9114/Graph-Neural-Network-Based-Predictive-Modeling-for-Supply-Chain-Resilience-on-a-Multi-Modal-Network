...
def load_data():
    ...
    # Load graph (with weights_only=False for PyTorch Geometric compatibility)
...
def main():
    ...
    print("="*70)
    print("GNN TRAINING FOR SUPPLY CHAIN RESILIENCE PREDICTION")
    print("="*70)
    ...
    print("\n✓ Results saved: training_results.csv")
    
    print("\n" + "="*70)
    print("✓ TRAINING COMPLETE!")
    print("="*70)
    print("\nGenerated files:")
    print("  - best_gnn_model.pt (trained model)")
    print("  - training_history.png (loss/accuracy plots)")
    print("  - confusion_matrix.png (test set confusion matrix)")
    print("  - training_results.csv (metrics summary)")

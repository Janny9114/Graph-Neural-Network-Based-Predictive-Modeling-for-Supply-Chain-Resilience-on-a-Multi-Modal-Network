...
Uses functions from for balanced class distribution.
...
# ✅ Import from core directory (11-feature code)
from core.generate_realistic_scenarios import RealisticDisruptionSimulator
from core.generate_edge_disruption_scenarios import EdgeDisruptionSimulator
from core.train_multi_gnn_realistic import (
...
from core.graph_construction import create_gnn_graph
from core.benchmark_ml_realistic import (
...
class CompletePipeline:
    """
    Complete training pipeline using functions from the .
    """
    ...
    def build_or_load_graph(self, graph_path='data/supply_chain_graph.pt',
                           node_path='data/synthetic_nodes.csv',
                           edge_path='data/synthetic_edges.csv'):
    ...
    def generate_scenarios(self, graph_path, num_scenarios=1000, scenario_type='node'):
        ...
        from core.generate_realistic_scenarios import load_preprocessed_graph
    ...
    def run(self, node_path='data/synthetic_nodes.csv',
            edge_path='data/synthetic_edges.csv',
